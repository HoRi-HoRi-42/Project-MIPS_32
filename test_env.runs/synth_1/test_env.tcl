...
read_vhdl -library xil_defaultlib {
  {D:/fac/Xinxin/Laborator AC/test_env/test_env.srcs/sources_1/new/SSD.vhd}
  {D:/fac/Xinxin/Laborator AC/test_env/test_env.srcs/sources_1/new/MPG.vhd}
  {D:/fac/Xinxin/Laborator AC/test_env/test_env.srcs/sources_1/new/test_env.vhd}
}
foreach dcp [get_files -quiet -all *.dcp] {
  set_property used_in_implementation false $dcp
}
read_xdc {{D:/fac/Xinxin/Laborator AC/test_env/test_env.srcs/constrs_1/new/test_env_constr.xdc}}
set_property used_in_implementation false [get_files {{D:/fac/Xinxin/Laborator AC/test_env/test_env.srcs/constrs_1/new/test_env_constr.xdc}}]
